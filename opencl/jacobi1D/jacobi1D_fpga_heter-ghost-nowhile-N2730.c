...
void cl_load_prog()
{
	...
	clConnect_1_6 = clCreateKernel(clProgram, "runJacobi1D_connect_1_6", &errcode);
	if(errcode != CL_SUCCESS) printf("Error in creating connect_1_6\n");
...
void cl_launch_kernels(int n)
{
	...
	// Set the arguments of the kernel
	  ...
	  errcode |=  clSetKernelArg(clKernel6, 1, sizeof(cl_mem), (void *)&a_mem_obj_k6);
        ...
        int foo = 0;
        errcode  |=  clSetKernelArg(clConnect_1_6, 0, sizeof(int), &foo);

	if(errcode != CL_SUCCESS) printf("Error in seting arguments of kernel1-6 or connect_1_6\n");
	...
	if(errcode != CL_SUCCESS) printf("Error in launching kernel6\n");
        ...
        cl_event event_connect_1_6;
	errcode = clEnqueueNDRangeKernel(clCommandQue, clConnect_1_6, 2, NULL, connect_globalWorkSize, connect_localWorkSize, 0, NULL, &event_connect_1_6);
	if(errcode != CL_SUCCESS) printf("Error in launching connect_1_6\n");
        printf("connect_1_6 is launched\n");
